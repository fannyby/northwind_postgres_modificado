...
-- Started on 2025-06-05 09:41:12
...
--
-- TOC entry 263 (class 1255 OID 16901)
-- Name: auditar_cambio_precio(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.auditar_cambio_precio() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Solo si hay un cambio en unit_price
  IF NEW.unit_price IS DISTINCT FROM OLD.unit_price THEN
    ...
    VALUES (
      ...
      OLD.unit_price::TEXT,
      NEW.unit_price::TEXT,
      current_user -- usuario de sesión actual
    );
  END IF;
  RETURN NEW;
END;
...
ALTER FUNCTION public.auditar_cambio_precio() OWNER TO postgres;

--
-- TOC entry 265 (class 1255 OID 16937)
-- Name: calcular_descuento_volumen(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calcular_descuento_volumen(producto_id integer, cantidad integer) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION public.calcular_descuento_volumen(producto_id integer, cantidad integer) OWNER TO postgres;

--
-- TOC entry 264 (class 1255 OID 16933)
-- Name: generar_alerta_stock(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.generar_alerta_stock() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- TOC entry 262 (class 1255 OID 16863)
-- Name: registrar_cambio_precio(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.registrar_cambio_precio() OWNER TO postgres;
...
-- Name: analisis_clientes; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.analisis_clientes AS
...
ALTER VIEW public.analisis_clientes OWNER TO postgres;
...
-- Name: product_audit; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.product_audit OWNER TO postgres;

--
-- TOC entry 256 (class 1259 OID 16881)
-- Name: product_audit_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.product_audit_id_seq OWNER TO postgres;

--
-- TOC entry 5125 (class 0 OID 0)
-- Dependencies: 256
-- Name: product_audit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.product_audit_id_seq OWNED BY public.product_audit.id;
...
--
-- TOC entry 259 (class 1259 OID 16892)
...
--
-- TOC entry 253 (class 1259 OID 16866)
...
--
-- TOC entry 252 (class 1259 OID 16865)
...
-- Name: volume_discounts; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.volume_discounts OWNER TO postgres;

--
-- TOC entry 254 (class 1259 OID 16874)
-- Name: volume_discounts_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.volume_discounts_id_seq OWNER TO postgres;

--
-- TOC entry 5128 (class 0 OID 0)
-- Dependencies: 254
-- Name: volume_discounts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE VIEW public.vw_estado_inventario AS
 SELECT product_id,
    ...
    reorder_level,
        CASE
            WHEN (units_in_stock <= reorder_level) THEN 'Reabastecer'::text
...
CREATE VIEW public.vw_ordenes_detalladas AS
 SELECT o.order_id,
    ...
    p.discontinued,
        CASE
            WHEN (p.discontinued = 1) THEN 'Discontinuado'::text
            ELSE 'Activo'::text
        END AS estado_producto,
    od.unit_price,
    od.quantity,
    od.discount,
    round((((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount)))::numeric, 2) AS total_linea_con_descuento
...
CREATE VIEW public.vw_performance_categorias AS
 SELECT cat.category_name,
    sum(((od.quantity)::double precision * od.unit_price)) AS total_ventas
   FROM ((public.categories cat
     JOIN public.products p ON ((cat.category_id = p.category_id)))
...
CREATE VIEW public.vw_performance_proveedores AS
 SELECT s.supplier_id,
    ...
    count(DISTINCT
        CASE
            WHEN (p.discontinued = 0) THEN p.product_id
            ELSE NULL::smallint
        END) AS productos_activos,
    count(DISTINCT
        CASE
            WHEN (p.discontinued = 1) THEN p.product_id
            ELSE NULL::smallint
        END) AS productos_discontinuados,
    COALESCE(sum(od.quantity), (0)::bigint) AS total_unidades_vendidas,
    round((COALESCE(sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))), (0)::double precision))::numeric, 2) AS total_ventas,
    round((COALESCE(avg(od.unit_price), (0)::double precision))::numeric, 2) AS precio_promedio_venta
   FROM ((public.suppliers s
     JOIN public.products p ON ((s.supplier_id = p.supplier_id)))
  ...
  ORDER BY (round((COALESCE(sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))), (0)::double precision))::numeric, 2)) DESC;


ALTER VIEW public.vw_performance_proveedores OWNER TO postgres;

--
-- TOC entry 245 (class 1259 OID 16786)
...
CREATE VIEW public.vw_precios_categoria AS
 SELECT cat.category_name,
    ...
    round((min(p.unit_price))::numeric, 2) AS precio_min,
    round((max(p.unit_price))::numeric, 2) AS precio_max
   FROM (public.categories cat
     JOIN public.products p ON ((cat.category_id = p.category_id)))
...
--
-- TOC entry 249 (class 1259 OID 16849)
-- Name: vw_productos_stock_bajo; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_productos_stock_bajo AS
 SELECT product_id,
    product_name,
    units_in_stock
   FROM public.products
...
ALTER VIEW public.vw_productos_stock_bajo OWNER TO postgres;
...
CREATE VIEW public.vw_stock_bajo AS
 SELECT product_name,
    ...
    reorder_level,
        ...
        END AS estado
   FROM public.products p
  WHERE ((units_in_stock <= reorder_level) AND (units_in_stock > 5) AND (discontinued = 0))
...
CREATE VIEW public.vw_top_clientes AS
 SELECT c.company_name,
    c.city,
    c.country,
    round((sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))))::numeric, 2) AS total_compras
   FROM ((public.customers c
     JOIN public.orders o ON (((c.customer_id)::text = (o.customer_id)::text)))
     JOIN public.order_details od ON ((o.order_id = od.order_id)))
  GROUP BY c.company_name, c.city, c.country
  ORDER BY (round((sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))))::numeric, 2)) DESC
 LIMIT 10;
...
CREATE VIEW public.vw_top_productos AS
 SELECT p.product_name,
    (sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))))::numeric(10,2) AS total_vendido
   FROM (public.products p
     JOIN public.order_details od ON ((p.product_id = od.product_id)))
  GROUP BY p.product_name
  ORDER BY ((sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))))::numeric(10,2)) DESC
 LIMIT 10;
...
--
-- TOC entry 260 (class 1259 OID 16908)
-- Name: vw_top_productos_vendidos; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_top_productos_vendidos AS
 SELECT p.product_id,
    p.product_name,
...
ALTER VIEW public.vw_top_productos_vendidos OWNER TO postgres;

--
-- TOC entry 246 (class 1259 OID 16791)
-- Name: vw_ventas_categoria; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_ventas_categoria AS
 SELECT cat.category_name,
    round((sum(((od.unit_price * (od.quantity)::double precision) * ((1)::double precision - od.discount))))::numeric, 2) AS total_categoria
   FROM ((public.categories cat
     JOIN public.products p ON ((cat.category_id = p.category_id)))
     JOIN public.order_details od ON ((p.product_id = od.product_id)))
  GROUP BY cat.category_name
...
--
-- TOC entry 238 (class 1259 OID 16742)
...
CREATE VIEW public.vw_ventas_empleado AS
 SELECT e.employee_id,
    (((e.first_name)::text || ' '::text) || (e.last_name)::text) AS empleado,
    round((sum((od.unit_price * (od.quantity)::double precision)))::numeric, 2) AS total_ventas
   FROM ((public.employees e
     JOIN public.orders o ON ((e.employee_id = o.employee_id)))
     JOIN public.order_details od ON ((o.order_id = od.order_id)))
  GROUP BY e.employee_id, (((e.first_name)::text || ' '::text) || (e.last_name)::text);
...
-- Name: vw_ventas_pais_participacion; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_ventas_pais_participacion AS
 SELECT c.country,
    round((sum((od.unit_price * (od.quantity)::double precision)))::numeric, 2) AS total_ventas,
    round((((sum((od.unit_price * (od.quantity)::double precision)) / sum(sum((od.unit_price * (od.quantity)::double precision))) OVER ()))::numeric * (100)::numeric), 2) AS participacion_porcentual
   FROM ((public.customers c
     JOIN public.orders o ON (((c.customer_id)::text = (o.customer_id)::text)))
     JOIN public.order_details od ON ((o.order_id = od.order_id)))
  GROUP BY c.country
  ORDER BY (round((sum((od.unit_price * (od.quantity)::double precision)))::numeric, 2)) DESC;


ALTER VIEW public.vw_ventas_pais_participacion OWNER TO postgres;
...
--
-- TOC entry 4861 (class 2604 OID 16857)
...
--
-- TOC entry 4865 (class 2604 OID 16885)
-- Name: product_audit id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_audit ALTER COLUMN id SET DEFAULT nextval('public.product_audit_id_seq'::regclass);


--
-- TOC entry 4867 (class 2604 OID 16895)
...
--
-- TOC entry 4863 (class 2604 OID 16869)
...
--
-- TOC entry 4864 (class 2604 OID 16878)
-- Name: volume_discounts id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 5095 (class 0 OID 16449)
-- Dependencies: 217
...
--
-- TOC entry 5096 (class 0 OID 16454)
-- Dependencies: 218
...
--
-- TOC entry 5097 (class 0 OID 16457)
-- Dependencies: 219
...
--
-- TOC entry 5098 (class 0 OID 16462)
-- Dependencies: 220
...
--
-- TOC entry 5100 (class 0 OID 16470)
-- Dependencies: 222
...
--
-- TOC entry 5099 (class 0 OID 16465)
-- Dependencies: 221
...
--
-- TOC entry 5110 (class 0 OID 16854)
-- Dependencies: 251
-- Data for Name: historial_precios; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.historial_precios (id, product_id, precio_anterior, precio_nuevo, fecha_modificacion, modificado_por) FROM stdin;
1	101	599.99	649.99	2025-06-04 10:04:36.501974	admin
2	102	899.00	849.00	2025-06-04 10:04:36.501974	jgarcia
3	103	1200.50	1199.00	2025-06-04 10:04:36.501974	carmenp
4	104	399.99	429.99	2025-06-04 10:04:36.501974	admin
5	105	999.00	979.99	2025-06-04 10:04:36.501974	ventas_norte
6	106	750.00	770.00	2025-06-04 10:04:36.501974	luis_tec
7	107	320.00	290.00	2025-06-04 10:04:36.501974	admin
8	108	1500.00	1499.99	2025-06-04 10:04:36.501974	soporte
9	109	200.00	210.00	2025-06-04 10:04:36.501974	alicia
10	110	450.00	470.00	2025-06-04 10:04:36.501974	jorge_admin
11	1	18.00	579.99	2025-06-04 10:19:08.782625	postgres
\.
...
--
-- TOC entry 5102 (class 0 OID 16476)
-- Dependencies: 224
...
--
-- TOC entry 5116 (class 0 OID 16882)
-- Dependencies: 257
-- Data for Name: product_audit; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.product_audit (id, product_id, accion, campo_modificado, valor_anterior, valor_nuevo, fecha_modificacion, modificado_por) FROM stdin;
1	1	UPDATE	unit_price	599.99	579.99	2025-06-04 10:16:33.166363	admin
2	2	UPDATE	units_in_stock	100	80	2025-06-04 10:16:33.166363	jose
3	3	DELETE	\N	\N	\N	2025-06-04 10:16:33.166363	maria
4	4	UPDATE	unit_price	199.99	189.99	2025-06-04 10:16:33.166363	luis
5	5	UPDATE	unit_price	89.99	79.99	2025-06-04 10:16:33.166363	admin
6	6	UPDATE	unit_price	349.99	319.99	2025-06-04 10:16:33.166363	soporte
7	7	UPDATE	unit_price	79.99	69.99	2025-06-04 10:16:33.166363	ventas
8	8	UPDATE	unit_price	59.99	49.99	2025-06-04 10:16:33.166363	admin
9	9	UPDATE	unit_price	99.99	89.99	2025-06-04 10:16:33.166363	karla
10	10	UPDATE	unit_price	149.99	129.99	2025-06-04 10:16:33.166363	luis
11	1	UPDATE	unit_price	18	579.99	2025-06-04 10:19:08.782625	postgres
\.


--
-- TOC entry 5103 (class 0 OID 16479)
-- Dependencies: 225
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.products (product_id, product_name, supplier_id, category_id, quantity_per_unit, unit_price, units_in_stock, units_on_order, reorder_level, discontinued, caracteristicas_json, updated_at) FROM stdin;
2	Chang	1	1	24 - 12 oz bottles	19	17	40	25	1	\N	2025-06-04 11:49:01.593661
3	Aniseed Syrup	1	2	12 - 550 ml bottles	10	13	70	25	0	\N	2025-06-04 11:49:01.593661
4	Chef Anton's Cajun Seasoning	2	2	48 - 6 oz jars	22	53	0	0	0	\N	2025-06-04 11:49:01.593661
5	Chef Anton's Gumbo Mix	2	2	36 boxes	21.35	0	0	0	1	\N	2025-06-04 11:49:01.593661
6	Grandma's Boysenberry Spread	3	2	12 - 8 oz jars	25	120	0	25	0	\N	2025-06-04 11:49:01.593661
7	Uncle Bob's Organic Dried Pears	3	7	12 - 1 lb pkgs.	30	15	0	10	0	\N	2025-06-04 11:49:01.593661
8	Northwoods Cranberry Sauce	3	2	12 - 12 oz jars	40	6	0	0	0	\N	2025-06-04 11:49:01.593661
9	Mishi Kobe Niku	4	6	18 - 500 g pkgs.	97	29	0	0	1	\N	2025-06-04 11:49:01.593661
10	Ikura	4	8	12 - 200 ml jars	31	31	0	0	0	\N	2025-06-04 11:49:01.593661
11	Queso Cabrales	5	4	1 kg pkg.	21	22	30	30	0	\N	2025-06-04 11:49:01.593661
12	Queso Manchego La Pastora	5	4	10 - 500 g pkgs.	38	86	0	0	0	\N	2025-06-04 11:49:01.593661
13	Konbu	6	8	2 kg box	6	24	0	5	0	\N	2025-06-04 11:49:01.593661
14	Tofu	6	7	40 - 100 g pkgs.	23.25	35	0	0	0	\N	2025-06-04 11:49:01.593661
15	Genen Shouyu	6	2	24 - 250 ml bottles	13	39	0	5	0	\N	2025-06-04 11:49:01.593661
16	Pavlova	7	3	32 - 500 g boxes	17.45	29	0	10	0	\N	2025-06-04 11:49:01.593661
17	Alice Mutton	7	6	20 - 1 kg tins	39	0	0	0	1	\N	2025-06-04 11:49:01.593661
18	Carnarvon Tigers	7	8	16 kg pkg.	62.5	42	0	0	0	\N	2025-06-04 11:49:01.593661
19	Teatime Chocolate Biscuits	8	3	10 boxes x 12 pieces	9.2	25	0	5	0	\N	2025-06-04 11:49:01.593661
20	Sir Rodney's Marmalade	8	3	30 gift boxes	81	40	0	0	0	\N	2025-06-04 11:49:01.593661
21	Sir Rodney's Scones	8	3	24 pkgs. x 4 pieces	10	3	40	5	0	\N	2025-06-04 11:49:01.593661
22	Gustaf's Knäckebröd	9	5	24 - 500 g pkgs.	21	104	0	25	0	\N	2025-06-04 11:49:01.593661
23	Tunnbröd	9	5	12 - 250 g pkgs.	9	61	0	25	0	\N	2025-06-04 11:49:01.593661
24	Guaraná Fantástica	10	1	12 - 355 ml cans	4.5	20	0	0	1	\N	2025-06-04 11:49:01.593661
25	NuNuCa Nuß-Nougat-Creme	11	3	20 - 450 g glasses	14	76	0	30	0	\N	2025-06-04 11:49:01.593661
26	Gumbär Gummibärchen	11	3	100 - 250 g bags	31.23	15	0	0	0	\N	2025-06-04 11:49:01.593661
27	Schoggi Schokolade	11	3	100 - 100 g pieces	43.9	49	0	30	0	\N	2025-06-04 11:49:01.593661
28	Rössle Sauerkraut	12	7	25 - 825 g cans	45.6	26	0	0	1	\N	2025-06-04 11:49:01.593661
29	Thüringer Rostbratwurst	12	6	50 bags x 30 sausgs.	123.79	0	0	0	1	\N	2025-06-04 11:49:01.593661
30	Nord-Ost Matjeshering	13	8	10 - 200 g glasses	25.89	10	0	15	0	\N	2025-06-04 11:49:01.593661
31	Gorgonzola Telino	14	4	12 - 100 g pkgs	12.5	0	70	20	0	\N	2025-06-04 11:49:01.593661
32	Mascarpone Fabioli	14	4	24 - 200 g pkgs.	32	9	40	25	0	\N	2025-06-04 11:49:01.593661
33	Geitost	15	4	500 g	2.5	112	0	20	0	\N	2025-06-04 11:49:01.593661
34	Sasquatch Ale	16	1	24 - 12 oz bottles	14	111	0	15	0	\N	2025-06-04 11:49:01.593661
35	Steeleye Stout	16	1	24 - 12 oz bottles	18	20	0	15	0	\N	2025-06-04 11:49:01.593661
36	Inlagd Sill	17	8	24 - 250 g  jars	19	112	0	20	0	\N	2025-06-04 11:49:01.593661
37	Gravad lax	17	8	12 - 500 g pkgs.	26	11	50	25	0	\N	2025-06-04 11:49:01.593661
38	Côte de Blaye	18	1	12 - 75 cl bottles	263.5	17	0	15	0	\N	2025-06-04 11:49:01.593661
39	Chartreuse verte	18	1	750 cc per bottle	18	69	0	5	0	\N	2025-06-04 11:49:01.593661
40	Boston Crab Meat	19	8	24 - 4 oz tins	18.4	123	0	30	0	\N	2025-06-04 11:49:01.593661
41	Jack's New England Clam Chowder	19	8	12 - 12 oz cans	9.65	85	0	10	0	\N	2025-06-04 11:49:01.593661
42	Singaporean Hokkien Fried Mee	20	5	32 - 1 kg pkgs.	14	26	0	0	1	\N	2025-06-04 11:49:01.593661
43	Ipoh Coffee	20	1	16 - 500 g tins	46	17	10	25	0	\N	2025-06-04 11:49:01.593661
44	Gula Malacca	20	2	20 - 2 kg bags	19.45	27	0	15	0	\N	2025-06-04 11:49:01.593661
45	Rogede sild	21	8	1k pkg.	9.5	5	70	15	0	\N	2025-06-04 11:49:01.593661
46	Spegesild	21	8	4 - 450 g glasses	12	95	0	0	0	\N	2025-06-04 11:49:01.593661
47	Zaanse koeken	22	3	10 - 4 oz boxes	9.5	36	0	0	0	\N	2025-06-04 11:49:01.593661
48	Chocolade	22	3	10 pkgs.	12.75	15	70	25	0	\N	2025-06-04 11:49:01.593661
49	Maxilaku	23	3	24 - 50 g pkgs.	20	10	60	15	0	\N	2025-06-04 11:49:01.593661
50	Valkoinen suklaa	23	3	12 - 100 g bars	16.25	65	0	30	0	\N	2025-06-04 11:49:01.593661
51	Manjimup Dried Apples	24	7	50 - 300 g pkgs.	53	20	0	10	0	\N	2025-06-04 11:49:01.593661
52	Filo Mix	24	5	16 - 2 kg boxes	7	38	0	25	0	\N	2025-06-04 11:49:01.593661
53	Perth Pasties	24	6	48 pieces	32.8	0	0	0	1	\N	2025-06-04 11:49:01.593661
54	Tourtière	25	6	16 pies	7.45	21	0	10	0	\N	2025-06-04 11:49:01.593661
55	Pâté chinois	25	6	24 boxes x 2 pies	24	115	0	20	0	\N	2025-06-04 11:49:01.593661
56	Gnocchi di nonna Alice	26	5	24 - 250 g pkgs.	38	21	10	30	0	\N	2025-06-04 11:49:01.593661
57	Ravioli Angelo	26	5	24 - 250 g pkgs.	19.5	36	0	20	0	\N	2025-06-04 11:49:01.593661
58	Escargots de Bourgogne	27	8	24 pieces	13.25	62	0	20	0	\N	2025-06-04 11:49:01.593661
59	Raclette Courdavault	28	4	5 kg pkg.	55	79	0	0	0	\N	2025-06-04 11:49:01.593661
60	Camembert Pierrot	28	4	15 - 300 g rounds	34	19	0	0	0	\N	2025-06-04 11:49:01.593661
61	Sirop d'érable	29	2	24 - 500 ml bottles	28.5	113	0	25	0	\N	2025-06-04 11:49:01.593661
62	Tarte au sucre	29	3	48 pies	49.3	17	0	0	0	\N	2025-06-04 11:49:01.593661
63	Vegie-spread	7	2	15 - 625 g jars	43.9	24	0	5	0	\N	2025-06-04 11:49:01.593661
64	Wimmers gute Semmelknödel	12	5	20 bags x 4 pieces	33.25	22	80	30	0	\N	2025-06-04 11:49:01.593661
65	Louisiana Fiery Hot Pepper Sauce	2	2	32 - 8 oz bottles	21.05	76	0	0	0	\N	2025-06-04 11:49:01.593661
66	Louisiana Hot Spiced Okra	2	2	24 - 8 oz jars	17	4	100	20	0	\N	2025-06-04 11:49:01.593661
67	Laughing Lumberjack Lager	16	1	24 - 12 oz bottles	14	52	0	10	0	\N	2025-06-04 11:49:01.593661
68	Scottish Longbreads	8	3	10 boxes x 8 pieces	12.5	6	10	15	0	\N	2025-06-04 11:49:01.593661
69	Gudbrandsdalsost	15	4	10 kg pkg.	36	26	0	15	0	\N	2025-06-04 11:49:01.593661
70	Outback Lager	7	1	24 - 355 ml bottles	15	15	10	30	0	\N	2025-06-04 11:49:01.593661
71	Flotemysost	15	4	10 - 500 g pkgs.	21.5	26	0	0	0	\N	2025-06-04 11:49:01.593661
72	Mozzarella di Giovanni	14	4	24 - 200 g pkgs.	34.8	14	0	0	0	\N	2025-06-04 11:49:01.593661
73	Röd Kaviar	17	8	24 - 150 g jars	15	101	0	5	0	\N	2025-06-04 11:49:01.593661
74	Longlife Tofu	4	7	5 kg pkg.	10	4	20	5	0	\N	2025-06-04 11:49:01.593661
75	Rhönbräu Klosterbier	12	1	24 - 0.5 l bottles	7.75	125	0	25	0	\N	2025-06-04 11:49:01.593661
76	Lakkalikööri	23	1	500 ml	18	57	0	20	0	\N	2025-06-04 11:49:01.593661
77	Original Frankfurter grüne Soße	12	2	12 boxes	13	32	0	15	0	\N	2025-06-04 11:49:01.593661
101	Smartphone XYZ	1	1	1 unidad	599.99	20	5	10	0	{"tags": ["gaming", "android"], "marca": "TechPro", "categoria": "electrónicos", "subcategoria": "smartphones"}	2025-06-04 11:49:01.593661
103	Auriculares Wireless X	3	1	1 unidad	150	50	10	15	0	{"tags": ["audio", "wireless", "gaming"], "marca": "SoundMax", "colores": ["negro", "blanco"], "categoria": "electrónicos", "subcategoria": "auriculares", "especificaciones": {"tipo": "Bluetooth", "autonomia": "20h", "cancelacion_ruido": "activa"}}	2025-06-04 11:49:01.593661
1	Chai	8	1	10 boxes x 30 bags	579.99	39	0	10	1	\N	2025-06-04 11:49:01.593661
102	Producto de prueba	1	1	1 unidad	10	100	0	10	0	\N	2025-06-04 12:36:43.677433
\.


--
-- TOC entry 5104 (class 0 OID 16482)
-- Dependencies: 226
...
--
-- TOC entry 5105 (class 0 OID 16485)
-- Dependencies: 227
...
--
-- TOC entry 5118 (class 0 OID 16892)
-- Dependencies: 259
-- Data for Name: stock_alerts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.stock_alerts (id, product_id, mensaje, fecha_alerta, nivel_stock_actual) FROM stdin;
1	1	Stock por debajo del mínimo	2025-06-04 10:17:17.278763	3
2	2	Producto agotado	2025-06-04 10:17:17.278763	0
3	3	Reponer stock pronto	2025-06-04 10:17:17.278763	7
4	4	Stock por debajo del mínimo	2025-06-04 10:17:17.278763	5
5	5	Producto casi agotado	2025-06-04 10:17:17.278763	2
6	6	Revisión urgente de inventario	2025-06-04 10:17:17.278763	0
7	7	Stock por debajo del mínimo	2025-06-04 10:17:17.278763	4
8	8	Nivel crítico de inventario	2025-06-04 10:17:17.278763	1
9	9	Agotado en bodega principal	2025-06-04 10:17:17.278763	0
10	10	Inventario por revisar	2025-06-04 10:17:17.278763	6
\.


--
-- TOC entry 5112 (class 0 OID 16866)
-- Dependencies: 253
...
--
-- TOC entry 5106 (class 0 OID 16488)
-- Dependencies: 228
...
--
-- TOC entry 5114 (class 0 OID 16875)
-- Dependencies: 255
-- Data for Name: volume_discounts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.volume_discounts (id, product_id, cantidad_minima, porcentaje_descuento) FROM stdin;
1	1	10	5.00
2	2	20	7.50
3	3	15	6.00
4	4	50	10.00
...
SELECT pg_catalog.setval('public.historial_precios_id_seq', 11, true);


--
-- TOC entry 5130 (class 0 OID 0)
-- Dependencies: 256
-- Name: product_audit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.product_audit_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.stock_alerts_id_seq', 10, true);
...
-- Dependencies: 254
-- Name: volume_discounts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.volume_discounts_id_seq', 10, true);


--
-- TOC entry 4898 (class 2606 OID 16862)
...
--
-- TOC entry 4880 (class 2606 OID 16510)
...
--
-- TOC entry 4878 (class 2606 OID 16508)
...
--
-- TOC entry 4884 (class 2606 OID 16514)
...
--
-- TOC entry 4886 (class 2606 OID 16516)
...
--
-- TOC entry 4888 (class 2606 OID 16518)
...
--
-- TOC entry 4890 (class 2606 OID 16520)
...
--
-- TOC entry 4892 (class 2606 OID 16522)
...
--
-- TOC entry 4904 (class 2606 OID 16890)
-- Name: product_audit product_audit_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_audit
    ADD CONSTRAINT product_audit_pkey PRIMARY KEY (id);
...
--
-- TOC entry 4900 (class 2606 OID 16873)
...
--
-- TOC entry 4902 (class 2606 OID 16880)
-- Name: volume_discounts volume_discounts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.volume_discounts
    ADD CONSTRAINT volume_discounts_pkey PRIMARY KEY (id);


--
-- TOC entry 4924 (class 2620 OID 16940)
-- Name: products trg_actualizar_timestamp; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_actualizar_timestamp BEFORE UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- TOC entry 4925 (class 2620 OID 16934)
-- Name: products trg_alerta_stock; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_alerta_stock AFTER UPDATE ON public.products FOR EACH ROW WHEN ((new.units_in_stock < new.reorder_level)) EXECUTE FUNCTION public.generar_alerta_stock();


--
-- TOC entry 4926 (class 2620 OID 16931)
-- Name: products trg_auditoria_precio; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_auditoria_precio AFTER UPDATE ON public.products FOR EACH ROW WHEN ((old.unit_price IS DISTINCT FROM new.unit_price)) EXECUTE FUNCTION public.registrar_cambio_precio();


--
-- TOC entry 4927 (class 2620 OID 16902)
-- Name: products trigger_auditar_precio; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_auditar_precio AFTER UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.auditar_cambio_precio();


--
-- TOC entry 4928 (class 2620 OID 16864)
-- Name: products trigger_historial_precios; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_historial_precios AFTER UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.registrar_cambio_precio();


--
-- TOC entry 4923 (class 2606 OID 16961)
-- Name: stock_alerts fk_alerta_producto; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.stock_alerts
    ADD CONSTRAINT fk_alerta_producto FOREIGN KEY (product_id) REFERENCES public.products(product_id);


--
-- TOC entry 4922 (class 2606 OID 16966)
-- Name: product_audit fk_auditoria_producto; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_audit
    ADD CONSTRAINT fk_auditoria_producto FOREIGN KEY (product_id) REFERENCES public.products(product_id);
...
--
-- TOC entry 4908 (class 2606 OID 16582)
...
--
-- TOC entry 4921 (class 2606 OID 16951)
-- Name: volume_discounts fk_descuento_producto; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.volume_discounts
    ADD CONSTRAINT fk_descuento_producto FOREIGN KEY (product_id) REFERENCES public.products(product_id);


--
-- TOC entry 4910 (class 2606 OID 16572)
...
--
-- TOC entry 4911 (class 2606 OID 16567)
...
--
-- TOC entry 4909 (class 2606 OID 16587)
...
--
-- TOC entry 4912 (class 2606 OID 16547)
...
--
-- TOC entry 4914 (class 2606 OID 16527)
...
--
-- TOC entry 4915 (class 2606 OID 16532)
...
--
-- TOC entry 4916 (class 2606 OID 16537)
...
--
-- TOC entry 4920 (class 2606 OID 16956)
-- Name: subcategories fk_subcategoria_categoria; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subcategories
    ADD CONSTRAINT fk_subcategoria_categoria FOREIGN KEY (category_id) REFERENCES public.categories(category_id);


--
-- TOC entry 4919 (class 2606 OID 16562)
...
-- Completed on 2025-06-05 09:41:12
